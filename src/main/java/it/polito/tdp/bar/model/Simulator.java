...
public class Simulator {
	...
	private void processaEvento (Event e) {
		...
		case ARRIVO_GRUPPO_CLIENTI:{
			...
			if (tavolo!=null) {
				System.out.println("Trovato un tavolo da "+tavolo.getPosti()+"per "+e.getnPersone());
				...
				if(bancone<=e.getTolleranza()) {
					...
					//non si fermano al bancone 
					statistiche.incrementaInsoddisfatti(e.getnPersone());
					System.out.println(e.getnPersone()+" non si fermano al bancone"); 
				}
			}
			break; 
